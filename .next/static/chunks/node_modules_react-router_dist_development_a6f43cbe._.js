...
function getRouteInstrumentationUpdates(fns, route) {
    ...
    if (typeof route.lazy === "object") {
        ...
        [
            ...
            let instrumentations = aggregated["lazy.".concat(key)];
    ...
    [
        ...
        if (typeof handler === "function" && aggregated[key].length > 0) {
            ...
            let original = (_handler_UninstrumentedSymbol = handler[UninstrumentedSymbol]) !== null && _handler_UninstrumentedSymbol !== void 0 ? _handler_UninstrumentedSymbol : handler;
            let instrumented = wrapImpl(aggregated[key], original, function() {
    ...
    if (route.middleware && route.middleware.length > 0 && aggregated.middleware.length > 0) {
        updates.middleware = route.middleware.map((middleware)=>{
            ...
            let original = (_middleware_UninstrumentedSymbol = middleware[UninstrumentedSymbol]) !== null && _middleware_UninstrumentedSymbol !== void 0 ? _middleware_UninstrumentedSymbol : middleware;
            let instrumented = wrapImpl(aggregated.middleware, original, function() {
                for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                    args[_key] = arguments[_key];
                }
                return getHandlerInfo(args[0]);
...
function instrumentClientSideRouter(router, fns) {
    ...
    if (aggregated.navigate.length > 0) {
        ...
        let navigate = (_router_navigate_UninstrumentedSymbol = router.navigate[UninstrumentedSymbol]) !== null && _router_navigate_UninstrumentedSymbol !== void 0 ? _router_navigate_UninstrumentedSymbol : router.navigate;
        let instrumentedNavigate = wrapImpl(aggregated.navigate, navigate, function() {
            for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                args[_key] = arguments[_key];
            }
            let [to, opts] = args;
    ...
    if (aggregated.fetch.length > 0) {
        ...
        let fetch2 = (_router_fetch_UninstrumentedSymbol = router.fetch[UninstrumentedSymbol]) !== null && _router_fetch_UninstrumentedSymbol !== void 0 ? _router_fetch_UninstrumentedSymbol : router.fetch;
        let instrumentedFetch = wrapImpl(aggregated.fetch, fetch2, function() {
            for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                args[_key] = arguments[_key];
            }
...
function createStaticHandler(routes, opts) {
    ...
    let _mapRouteProperties = (opts === null || opts === void 0 ? void 0 : opts.mapRouteProperties) || defaultMapRouteProperties;
    let mapRouteProperties2 = _mapRouteProperties;
...
function getDataStrategyMatch(mapRouteProperties2, manifest, request, unstable_pattern, match, lazyRoutePropertiesToSkip, scopedContext, shouldLoad) {
    let unstable_shouldRevalidateArgs = arguments.length > 8 && arguments[8] !== void 0 ? arguments[8] : null;
...
async function callLoaderOrAction(param) {
    let { request, unstable_pattern, match, lazyHandlerPromise, lazyRoutePromise, handlerOverride, scopedContext } = param;
    let result;
    let onReject;
...
function useRoute() {
    ...
    var _args_;
    const id = (_args_ = args[0]) !== null && _args_ !== void 0 ? _args_ : currentRouteId;
    const state = useDataRouterState("useRoute" /* UseRoute */ );
    const route = state.matches.find((param)=>{
        let { route: route2 } = param;
        return route2.id === id;
    });
    ...
    return (routesByParentId[parentId] || []).map((route)=>{
        ...
        if (routeModule) {
            ...
            dataRoute.loader = async (param, singleFetch)=>{
                let { request, params, context, unstable_pattern } = param;
                try {
...
function createRoutesStub(routes, _context) {
    return function RoutesTestStub(param) {
        ...
        if (routerRef.current == null) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertRoutesToDataRoutes"])(routes, (r)=>r), _context !== void 0 ? _context : (future === null || future === void 0 ? void 0 : future.v8_middleware) ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterContextProvider"]() : {}, frameworkContextRef.current.manifest, frameworkContextRef.current.routeModules);
...
function processRoutes(routes, context, manifest, routeModules, parentId) {
    return routes.map((route)=>{
        ...
        let newRoute = {
            ...
            middleware: route.middleware ? route.middleware.map((mw)=>function() {
                    for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                        args[_key] = arguments[_key];
                    }
                    return mw({
        ...
        let commonRoute = {
            ...
            loader: route.module.loader ? async (args)=>{
                ...
                if (preRenderedData != null) {
                    ...
                    let decoded = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeViaTurboStream"])(stream, ("TURBOPACK ident replacement", globalThis));
...
function getDocumentHeaders(context, build) {
    return getDocumentHeadersImpl(context, (m)=>{
        ...
        invariant(route, 'Route with id "'.concat(m.route.id, '" not found in build'));
        ...
        if (!build.ssr) {
            ...
            if (build.prerender.length === 0) {
                ...
                if (url.pathname.endsWith(".data")) {
                    errorHandler(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorResponseImpl"](404, "Not Found", "Refusing to SSR the path `".concat(decodedPath, "` because `ssr:false` is set and the path is not included in the `prerender` config, so in production the path will be a 404.")), {
                        context: loadContext,
                        params,
                        request
                    });
...
function RSCStaticRouter(param) {
    ...
    const context = {
        get _deepestRenderedBoundaryId () {
            var _decoded__deepestRenderedBoundaryId;
            return (_decoded__deepestRenderedBoundaryId = decoded._deepestRenderedBoundaryId) !== null && _decoded__deepestRenderedBoundaryId !== void 0 ? _decoded__deepestRenderedBoundaryId : null;
        },
...
function getHydrationData(param) {
    let { state, routes, getRouteInfo, location, basename, isSpaMode } = param;
    let hydrationData = {
        ...state,
        loaderData: {
            ...state.loaderData
...
function createHydratedRouter(param) {
    let { getContext, unstable_instrumentations } = param;
    initSsrInfo();
    if (!ssrInfo) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "HydratedRouter.useEffect": ()=>{
            if (("TURBOPACK compile-time value", "development") === "development" && criticalCss === void 0) {
                document.querySelectorAll("[".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CRITICAL_CSS_DATA_ATTRIBUTE"], "]")).forEach({
...
__turbopack_context__.s({
    "BrowserRouter": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BrowserRouter"],
    "Form": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Form"],
    "HashRouter": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HashRouter"],
    "Link": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Link"],
    "Links": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Links"],
    "MemoryRouter": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MemoryRouter"],
    "Meta": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Meta"],
    "NavLink": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NavLink"],
    "Navigate": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Navigate"],
    "Outlet": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Outlet"],
    "Route": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Route"],
    "Router": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Router"],
    "RouterProvider": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterProvider"],
    "Routes": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Routes"],
    "ScrollRestoration": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollRestoration"],
    "StaticRouter": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaticRouter"],
    "StaticRouterProvider": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaticRouterProvider"],
    "UNSAFE_AwaitContextProvider": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AwaitContextProvider"],
    "UNSAFE_WithComponentProps": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WithComponentProps"],
    "UNSAFE_WithErrorBoundaryProps": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WithErrorBoundaryProps"],
    "UNSAFE_WithHydrateFallbackProps": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WithHydrateFallbackProps"],
    "unstable_HistoryRouter": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HistoryRouter"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$UIGDSWPH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/chunk-UIGDSWPH.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2d$react$2d$server$2d$client$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/index-react-server-client.mjs [app-client] (ecmascript) <locals>");
}),
...
__turbopack_context__.s({
    ...
    "UNSAFE_AwaitContextProvider": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2d$react$2d$server$2d$client$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["UNSAFE_AwaitContextProvider"],
...
//# sourceMappingURL=node_modules_react-router_dist_development_a6f43cbe._.js.map